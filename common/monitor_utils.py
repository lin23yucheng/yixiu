...
class MonitorUtils:
    ...
    # def monitor_cut_progress(self, task_name):
    #     """
    #     监控数据处理状态
    #     :param task_name: 任务名称
    #     :return: (trainTaskId, 是否成功)
    ...
    #
    #                 # 状态和时间信息
    #                 status_info = f"当前状态: {status} (0=处理中, 1=完成, 2=异常)"
    #                 self.safe_attach(status_info, name="状态解析")
    #                 self.safe_attach(f"trainTaskId: {trainTaskId}", name="任务ID")
    #
    #                 # 时间统计
    ...
    #                 # 状态判断
    #                 if status == 1:
    #                     self.safe_attach("训练任务已完成", name="状态更新")
    #                     print("\n数据处理已完成")
    #                     return trainTaskId, True
    #                 elif status == 2:
    #                     error_msg = current_task.get('errorMsg', '处理异常')
    #                     pytest.fail(f"训练异常: {error_msg}")
    #
    #                 # 超时检查
    #                 elapsed = time.time() - start_time
    #                 if elapsed > self.max_wait_seconds:
    ...
    # def monitor_train_progress(self, trainTaskId):
    #     """
    #     监控模型训练状态
    #     :param trainTaskId: 训练任务ID
    #     :return: (modelTrainId, 是否成功)
    ...
    #                     f"-------------------------------\n"
    #                 )
    #                 self.safe_attach(status_info, name="状态详情")
    #
    #                 # 控制台实时打印
    ...
    #                         pytest.fail("验证失败，请检查日志")
    #                     elif verify_status == 3:
    #                         self.safe_attach("训练&验证已完成", name="最终状态")
    #                         return modelTrainId, True
    #
    #                 # 超时检查
    #                 elapsed = time.time() - start_time
    ...
    # def monitor_commit_progress(self, trainTaskId):
    #     """
    #     监控模型提交状态
    #     :param trainTaskId: 训练任务ID
    #     :return: 是否成功
    ...
    #                     f"-------------------------------\n"
    #                 )
    #                 self.safe_attach(status_info, name="提交状态详情")
    #
    #                 # 控制台实时打印
    ...
    #                 elif commit_status == 1:
    #                     self.safe_attach("模型提交已完成", name="最终状态")
    #                     return True
    #
    #                 # 超时检查
    #                 elapsed = time.time() - start_time
