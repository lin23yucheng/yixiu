        ...
        with allure.step("监控报表分析状态"):
            while True:
                ...
                with allure.step(f"第{attempt}次提交状态检查"):
                    ...
                    allure.attach(status_info, name="报表分析状态详情")
                    ...
                    # 状态判断
                    if subStatus == 2:
                        allure.attach("报表分析已完成", name="最终状态")
                        time.sleep(3)
                        return True
                    elif subStatus == 1:
                        pass  # 继续循环
                    ...
                    if elapsed > self.max_wait_seconds:
                        pytest.fail(f"报表分析卡住，请检查日志（等待超过{self.max_wait_seconds}秒）")
