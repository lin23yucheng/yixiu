...
from common.Log import MyLog  # 导入日志模块
...
class Test_check_samples:
    ...
    def test_samples_add(self):
        ...
        try:
            ...
            MyLog.error(f"新增检测样例失败: {str(e)}")
            pytest.fail(f"新增检测样例失败: {str(e)}")
    ...
    def test_samples_query(self):
        ...
        try:
            ...
            MyLog.error(f"查询检测样例失败: {str(e)}")
            pytest.fail(f"查询检测样例失败: {str(e)}")
    ...
    def test_samples_update(self):
        try:
            ...
            MyLog.error(f"修改检测样例失败: {str(e)}")
            pytest.fail(f"修改检测样例失败: {str(e)}")
    ...
    def test_samples_delete(self):
        try:
            ...
            MyLog.error(f"删除检测样例失败: {str(e)}")
            pytest.fail(f"删除检测样例失败: {str(e)}")
